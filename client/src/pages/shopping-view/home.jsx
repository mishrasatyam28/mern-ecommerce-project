...
import { Airplay, BabyIcon, ChevronLeftIcon, ChevronRightIcon, CloudLightning, Factory, Heater, Image, Shirt, ShirtIcon, ShoppingBasket, UmbrellaIcon, WatchIcon } from 'lucide-react'
...
const brandsWithIcon = [
  ...
  { id: "adidas", label: "Adidas", icon:Factory },
...
const ShoppingHome = () => {
  ...
  useEffect(() => {
    dispatch(fetchAllFilteredProducts({ filterParam : {}, sortParams : 'price-lowtohigh'}))
  }, [dispatch])
