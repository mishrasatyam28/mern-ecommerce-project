...
function ProductImageUpload({
    ...
    // Image file drag function
    function handleDragOver(event) {
        event.preventDefault()
    }
    // Image file drop function
    ...
    return (
        <div className="w-full max-w-md mx-auto mt-4">
            ...
            <div onDragOver={handleDragOver} onDrop={handleDrop} className={`${isEditMode ? "opacity-40" :" "} border-2 border-dashed rounded-lg p-4`}>
                <Input
                    id="image-upload"
                    type="file"
                    className="hidden"
